...
//}
    ...
    Java_xingkong_demo_rs_MainActivity_nativeRsMono(JNIEnv *env, jobject instance,
 ...
 */
//JNIEXPORT void JNICALL
//Java_xingkong_demo_rs_MainActivity_nativeNeonMono(JNIEnv *env, jobject instance,
